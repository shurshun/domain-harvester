...
`ct install` (see Commands) proves the "CRD absent" path for real, not just against the fake client: `charts/domain-harvester/ci/crds-absent-values.yaml` enables all three sources and installs into a kind cluster that has none of the CRDs.
